  ...
  console.log(title, description, rating);
    ...
    let htmlTemplate = `
      ...
      <section class="text-info">
        ...
        <div class="read-review"><div class="review"><img src="img/stars.png"/><h3>Good Movie</h3>
...
function scrollArrow (){
  ...
  let infoText = document.getElementByClassName("text-info");
  let moreText = document.getElementByClassName("read-review");
